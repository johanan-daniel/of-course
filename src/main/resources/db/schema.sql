...
CREATE TABLE IF NOT EXISTS Furthest_Interview (
	id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	label VARCHAR(50) NOT NULL UNIQUE
);
...
CREATE TABLE IF NOT EXISTS Job (
	...
	furthest_interview_id INTEGER NOT NULL,
	...
	FOREIGN KEY (furthest_interview_id) REFERENCES Furthest_Interview(id),
	FOREIGN KEY (level_id) REFERENCES Level(id)
);


CREATE TABLE job_located_in (
	job_id INTEGER,
	location_id INTEGER,
...
CREATE TABLE skill_grouped_with (
	skill_id INTEGER,
